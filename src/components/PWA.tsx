  ...
  return (
    <div className="fixed bottom-20 left-4 right-4 z-50 max-w-lg mx-auto animate-slide-up">
      <div className="card-floating p-4 flex items-center gap-3 bg-red-600/90 backdrop-blur-xl border-red-500/30">
        ...
        <button onClick={() => setDismissed(true)} className="p-1 rounded-[7px] hover:bg-white/20 transition-colors">
  ...
  return (
    <div className="fixed bottom-20 left-4 right-4 z-50 max-w-lg mx-auto animate-slide-up">
      <div className="card-floating p-4 flex items-center gap-3">
        <div className="w-10 h-10 rounded-[7px] bg-gradient-to-br from-slate-700 to-slate-800 flex items-center justify-center shadow-[0_2px_8px_rgba(0,0,0,0.04),0_1px_2px_rgba(0,0,0,0.02)] shrink-0">
        ...
        <button onClick={install} className="btn-base h-9 px-4 rounded-[7px] bg-indigo-700 text-white text-xs font-semibold shadow-[0_2px_8px_rgba(67,56,202,0.2)] hover:bg-indigo-800 active:scale-95 transition-all">
          Install
        </button>
        <button onClick={() => setShow(false)} className="p-1.5 rounded-[7px] text-gray-400 hover:text-gray-600 hover:bg-gray-100 transition-colors">
          <X className="w-4 h-4" />
        </button>
      </div>
    </div>
