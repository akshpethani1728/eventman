      ...
      <main className="max-w-lg mx-auto px-4 pt-4">
        <div className="bg-gradient-to-br from-[#0D9488] via-[#0D9488] to-[#0F766E] rounded-[20px] p-5 mb-5 shadow-[0_8px_32px_rgba(13,148,136,0.2)]">
          <div className="flex items-center justify-between mb-4">
            <div>
              <p className="text-white/70 text-xs font-medium">Operations Overview</p>
              <h2 className="text-white text-lg font-bold mt-0.5">Command Center</h2>
            </div>
            <div className="flex items-center gap-1.5 bg-white/15 rounded-[10px] px-2.5 py-1.5 backdrop-blur-sm">
              <Activity className="w-3.5 h-3.5 text-white/80" />
              <span className="text-white/80 text-xs font-semibold">Live</span>
            </div>
          </div>
          <div className="grid grid-cols-2 gap-3">
            <div className="bg-white/15 rounded-[14px] p-3.5 backdrop-blur-sm">
              <p className="text-white/60 text-[10px] font-medium uppercase tracking-wide">Active Events</p>
              <p className="text-white text-2xl font-bold mt-0.5">{activeEvents.length}</p>
              <div className="flex items-center gap-1 mt-1">
                <Target className="w-3 h-3 text-white/50" />
                <span className="text-white/50 text-[10px]">{totalWorkersNeeded} roles to fill</span>
              </div>
            </div>
            <div className="bg-white/15 rounded-[14px] p-3.5 backdrop-blur-sm">
              <p className="text-white/60 text-[10px] font-medium uppercase tracking-wide">Pending Reviews</p>
              <p className="text-white text-2xl font-bold mt-0.5">{totalPendingApprovals}</p>
              <div className="flex items-center gap-1 mt-1">
                <Users className="w-3 h-3 text-white/50" />
                <span className="text-white/50 text-[10px]">applicants to review</span>
              </div>
            </div>
            <div className="bg-white/15 rounded-[14px] p-3.5 backdrop-blur-sm">
              <p className="text-white/60 text-[10px] font-medium uppercase tracking-wide">Needs Attention</p>
              <p className="text-white text-2xl font-bold mt-0.5">{needsAttention.length}</p>
              <div className="flex items-center gap-1 mt-1">
                <AlertTriangle className="w-3 h-3 text-amber-300" />
                <span className="text-white/50 text-[10px]">require action</span>
              </div>
            </div>
            <div className="bg-white/15 rounded-[14px] p-3.5 backdrop-blur-sm">
              <p className="text-white/60 text-[10px] font-medium uppercase tracking-wide">Fill Rate</p>
              ...
              <div className="flex items-center gap-1 mt-1">
                ...
                <span className="text-white/50 text-[10px]">overall progress</span>
              </div>
            </div>
          </div>
        </div>
