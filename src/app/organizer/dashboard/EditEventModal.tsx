  ...
  return (
    <div className="fixed inset-0 bg-black/50 z-50 flex items-start justify-center pt-6 p-3 overflow-y-auto modal-overlay">
      <div className="w-full max-w-xl modal-body">
        {/* Header */}
        <div className="bg-gradient-to-br from-violet-600 via-violet-700 to-purple-800 rounded-t-3xl px-5 py-5 text-white">
          ...
          <div className="mt-3 flex items-center gap-3">
            ...
            <select value={form.status} onChange={e => update("status", e.target.value)}
              className="h-8 px-3 rounded-2xl bg-white/15 border border-white/20 text-white text-xs font-medium backdrop-blur-sm outline-none">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="pt-2">
              <button type="submit" disabled={loading}
                className="w-full h-12 rounded-2xl bg-gradient-to-r from-violet-600 to-purple-700 text-white font-semibold text-sm flex items-center justify-center gap-2 disabled:opacity-50 hover:from-violet-700 hover:to-purple-800 active:scale-[0.98] transition-all shadow-sm shadow-black/[0.03]">
                {loading ? (
