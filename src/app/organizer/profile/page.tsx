          ...
          <div className="bg-indigo-50/40 rounded-xl p-6 text-center shadow-sm shadow-black/[0.02] border border-indigo-100/50">
            ...
            <div className="flex items-center justify-center gap-2">
              ...
              {!profile?.is_trusted_organizer && profile?.status === "trusted" && (
                <span className="inline-flex items-center gap-0.5 text-[10px] font-semibold text-indigo-700 bg-indigo-50 border border-indigo-200/60 px-1.5 py-0.5 rounded-lg">
          ...
          <div className="bg-indigo-50/40 rounded-xl p-5 space-y-4 shadow-sm shadow-black/[0.02] border border-indigo-100/50">
            ...
            <div>
              ...
              <textarea value={form.bio} onChange={e => update("bio", e.target.value)}
                ...
                className="w-full h-20 px-3 py-2 rounded-lg border border-gray-300 bg-white text-sm resize-none outline-none focus:border-indigo-500 focus:ring-1 focus:ring-indigo-500/20 transition-all" />
            </div>
          </div>
